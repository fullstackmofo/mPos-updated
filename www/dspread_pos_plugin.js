...
var posPlug = {
	...
	printImage:function(success,fail){
		exec(success,fail,"dspread_pos_plugin","printImage",[]);
	},
	...
	updateEmvConfig:function(success,fail){
		exec(success,fail,"dspread_pos_plugin","updateEmvConfig",[]);
	}
